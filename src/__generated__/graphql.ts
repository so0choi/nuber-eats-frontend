...
export type CreateOrderItemInput = {
  choices?: InputMaybe<Array<OrderItemOptionInputType>>;
  dishId: Scalars['Int'];
};
...
export type OrderItem = {
  ...
  choices?: Maybe<Array<OrderItemChoice>>;
  createdAt: Scalars['DateTime'];
  dish: Dish;
  id: Scalars['Float'];
  updatedAt: Scalars['DateTime'];
